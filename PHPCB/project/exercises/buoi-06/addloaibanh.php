                  ...
                  <div class="row mb-3">
                     <div class="col-md-6">
                        <div class="form-floating mb-3 mb-md-0">
                           <input class="form-control" id="" name="maloai" type="text" placeholder="Vui long nhap ma loai banh" />
                           <label for="inputFirstName">Ma loai</label>
                        </div>
                     </div>
                     <div class="col-md-6">
                        <div class="form-floating">
                           <input class="form-control" id="" name="tenloai" type="text" placeholder="Vui long nhap ten loai" />
