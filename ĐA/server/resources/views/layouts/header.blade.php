<div id="header">
    ...
    <div class="header-body">
        <div class="container beta-relative">
            <div class="pull-left">
                <a href="index" id="logo"><img src="assets/dest/images/logo-cake.png" width="200px"
                        alt=""></a>
            </div>
                                ...
                                @foreach ($product_cart as $pro)
                                    <div class="cart-item">
                                        <div class="pull-right">
                                            <a href="xoa-gio-hang/{{ $pro['item']['id'] }}"> <i
                                                    class="fa fa-times"></i></a>
                                            <a href="them-vao-gio-hang/{{ $pro['item']['id'] }}"> <i
                                                    class="fa fa-plus"></i></a>
                                        </div>
                                        <div class="media">
                                            <a class="pull-left" href="#">
                                                <img src="image/product/{{ $pro['item']['image'] }}"
                                                    alt="{{ $pro['item']['image'] }}">
                                            </a>
