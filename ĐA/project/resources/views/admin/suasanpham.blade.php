                ...
                <form action="{{ route('editsanpham') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="pro_price"
                            placeholder="Nhập giá khuyến mãi"value="{{ $product->promotion_price }}" />
                    ...
                    <div class="form-group">
                        ...
                        <img src="image/product/{{ $product->image }}" width="150" alt="" />
                    </div>
                    <div class="form-group">
                        <label>Tình trạng sản phẩm</label>
                        <label class="radio-inline">
                            <input name="rdoStatus" value="1" {{ $product->new == 1 ? 'checked' : '' }}
                                type="radio">Mới
                        </label>
                        </label>
                        <label class="radio-inline">
                            <input name="rdoStatus" value="0" type="radio"
                                {{ $product->new == 0 ? 'checked' : '' }}>none </label>
