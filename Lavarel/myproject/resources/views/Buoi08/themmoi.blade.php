    ...
    <div class="col-md-6">
        ...
        <form action="{{route('lophoc.store')}}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="gvcn" class="form-control"  value="">
                @if($errors->has("gvcn"))
            ...
            <div class="mb-3">
                ...
                <input type="text" name="siso" class="form-control"  value="">
                @if($errors->has("siso"))
            ...
            <div class="mb-3">
                ...
                <input type="text" name="hocphi" class="form-control"  value="">
