...
Route::group(['prefix' => 'Buoi07'], function(){
	Route::group(['prefix' => 'monhoc'], function(){
		Route::get("lietke",[Buoi07Controller::class,"get_lietkemonhoc"])->name("lkmh");
	});
	
	Route::get("test", function(){
		//$bien = Khoa::where("makhoa","=",4)->get();
		//foreach($bien[0]->lophoc as $lh)
		//{
		//	echo $lh->tenlop . "<br/>";
		//}
		$sv = SinhVien::where("masv", "=", 1)->get();
		foreach($sv[0]->ketqua as $kq)
		{
			echo $kq->monhoc->tenmh . "<br>";
		}
	});
});
