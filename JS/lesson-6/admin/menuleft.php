 <head>
      ...
      <!-- site icon -->
      <link rel="icon" href="pluto-1.0.0/pluto-1.0.0/images/fevicon.png" type="image/png" />
      <!-- bootstrap css -->
      ...
      <script src="https://oss.maxcdn.com/libs/respond.pluto-1.0.0/js/1.4.2/respond.min.js"></script>
      <![endif]-->
   </head>
 <nav id="sidebar">
               <div class="sidebar_blog_1">
                  ...
                  <div class="sidebar_user_info">
                     ...
                     <div class="user_profle_side">
                        <div class="user_img"><img class="img-responsive" src="pluto-1.0.0/images/layout_img/user_img.jpg" alt="#" /></div>
                        <div class="user_info">
                           <h6>John David</h6>
